<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('setting-invitation.index')" :active="request()->routeIs('setting-invitation.index')">
                        {{ __('Setting Invitation') }}
                    </x-nav-link>
                    <x-nav-link :href="route('gallery.index')" :active="request()->routeIs('gallery.index')">
                        {{ __('Gallery Invitation') }}
                    </x-nav-link>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                    ...
                    <svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                        <path :class="{ 'hidden &xcl :open': open, 'inline-flex': !open }" class="inline-flex"
                            stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M4 6h16M4 12h16M4 18h16" />
                        <path :class="{ 'hidden &xcl: ! open': !open, 'inline-flex': open }" class="hidden"
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('setting-invitation.index')" :active="request()->routeIs('setting-invitation.index')">
                {{ __('Setting Invitation') }}
            </x-responsive-nav-link>
