...
<img class='zoombox-image slide' src='/assets/clone/icons/load.svg'>
...
<img class='zoombox-close zoombox-controls' src='/assets/clone/icons/close.png'>
<img class='zoombox-next zoombox-controls' src='/assets/clone/icons/next.png'>
<img class='zoombox-prev zoombox-controls' src='/assets/clone/icons/prev.png'>
<img class='zoombox-play zoombox-controls' src='/assets/clone/icons/play.png'>
<img class='zoombox-zoom-in zoombox-controls' src='/assets/clone/icons/zoom-in.png'>
<img class='zoombox-zoom-out zoombox-controls' src='/assets/clone/icons/zoom-out.png'>
...
checkPlay(isplay){this.zoomboxImage.style.transform=` translate(-50%,-50%) scale(1)`;if(isplay){this.isplaying=!1;this.zoomboxPlay.src=`/assets/clone/icons/play.png`;clearTimeout(this.slideTimeOut)}else{this.isplaying=!0;this.zoomboxPlay.src=`/assets/clone/icons/pause.png`;this.slideShow()}}
...
groupName.push(att)})
groupName.forEach((group)=>{var images=document.querySelectorAll(`[zoombox=${group}]`);images.forEach((img,index)=>{img.onclick=()=>{var groupName=img.getAttribute('zoombox');zoombox=new zoomboxImages(`[zoombox=${groupName}]`,img.src,img.getAttribute('src2'),img.alt,index);zoombox.execute();document.querySelector('.zoombox-close').src=`/assets/clone/icons/close.png`;document.querySelector('.zoombox-zoom-in').src=`/assets/clone/icons/zoom-in.png`;document.querySelector('.zoombox-zoom-out').src=`/assets/clone/icons/zoom-out.png`;document.querySelector('.zoombox-next').src=`/assets/clone/icons/next.png`;document.querySelector('.zoombox-prev').src=`/assets/clone/icons/prev.png`;document.querySelector('.zoombox-play').src=`/assets/clone/icons/play.png`}})})}
